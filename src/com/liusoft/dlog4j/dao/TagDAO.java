...
public class TagDAO extends DAO {
	...
	protected static List listObjectsForTags(SiteBean site, String beanName,
		...
		return executeQuery(hql.toString(), fromIdx, count, new Object[] {
				_BeanBase.I_STATUS_NORMAL, siteId, siteId,
				new Integer(objType), tagname });
	}
	...
	protected static List listObjectsForTags(String beanName,
		...
		return executeQuery(hql.toString(), fromIdx, count, new Object[] {
				_BeanBase.I_STATUS_NORMAL, new Integer(objType), tagname });
	}
	...
	protected static int gettObjectCountForTag(SiteBean site, int objType, String tagname) {
		return executeNamedStatAsInt("TAG_COUNT_OF_SITE", new Object[] {
				new Integer(site.getId()), new Integer(objType), tagname });
	}
