...
public class BBSReplyDAO extends DAO implements SearchDataProvider {
	...
	public static int getReplyCount(int site){
		...
		return executeStatAsInt(hql, TopicReplyBean.STATUS_NORMAL);
	}
	/**
	 * 分页列出某个帖子的所有回帖
	 * @param topic_id
	...
	public List fetchAfter(Date beginTime) throws Exception {
		return findNamedAll("LIST_TOPIC_REPLIES_AFTER", new Object[]{beginTime, new Integer(TopicReplyBean.STATUS_NORMAL)});
	}
